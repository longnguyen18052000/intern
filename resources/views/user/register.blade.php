...
<body>
    <header>
        ...
        <!-- login -->
        <div id="login" class="login w3-modal mt-5 mb-5">
                ...
                <div class="row">
                    ...
                    <div class="col-6 content mt-5 mb-5">
                        ...
                        <form action="{{ route('register.action') }}" method="POST" class="w-100">
                            ...
                            <div>
                                <label><strong>Tài khoản</strong></label>
                                <input type="text" name="name" placeholder="Tài khoản *" value=" {{ old('name') }}" require>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-6 content mt-5 mb-5">
                    ...
                    <form action="{{route ('register.action') }}" method="POST" class="w-100">
                        ...
                        <div>
                            <label><strong>Ngày tháng năm sinh</strong></label>
                            <input type="date" name="date_of_birth" placeholder="Ngày tháng năm sinh *" require>
                            @if($errors->any())
                        ...
                        <!-- <div>
                            <label><strong>Quận/Huyện</strong></label>
                            <select name="district" placeholder="Chọn Quận/Huyện *">
                                <option>Chọn Quận/Huyện</option>
                                <option value="{{ old('district') }}">Ba ĐÌnh</option>
                            </select>
                            @if($errors->any())
                            @foreach($errors->get('district') as $err)
                            <div class="text text-danger text-center">{{ $err }}</div>
