...
<body>
    ...
    <!-- login -->
    <div class="mt-5 mb-5 login">
        <div class="box-login bg-white">
            <div class="row">

                <div class="img col-4 d-flex justify-content-center align-items-center">
                    <img class="mt-5 mb-5" src="{{ asset('images/login-bg.png') }}" alt="logo" />
                </div>

                <div class="col-1"></div>

                <div class="content col-6">
                    <h4 class="mt-5"><strong>Đăng ký tài khoản thành công</strong></h4>
                    ...
                    <ol class="mt-5">
                        ...
                        <li><a href="{{ route('register') }}">Về trang quản lý tài khoản</a></li>
                        <li><a href="{{ route('home') }}">Quay trở về trang chủ</a></li>
